...
public class OrderTest {
    ...
    public void testIndeedSearch() throws Exception {
        ...
        WebElement element = driver.findElement(By.xpath("//*[@data-e2e='Venti']"));
...
//        actions.perform();
        ...
        driver.findElement(By.xpath("//*[@id=\"content\"]/div[3]/div/div[2]/div[1]/form/fieldset/div[4]/label/div")).click();

        //driver.findElement(By.xpath("//*[@data-e2e='Venti']")).click();
        //driver.findElement(By.xpath("//*[@id=\"content\"]/div[3]/div/div[2]/div[1]/form/fieldset/div[4]/label/div")).click();
    }
}
